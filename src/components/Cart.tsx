    ...
    return <Card className="group transition-all duration-200 hover-card">
        <div className="flex items-start gap-2 p-2">
          ...
          <div className="flex-1 min-w-0 space-y-1">
            ...
            {/* Description */}
            <div className="text-xs font-medium text-foreground pl-2">
            ...
            <div className="space-y-0.5 text-[10px] text-muted-foreground pl-2">
              <div className="flex items-center gap-1">
                <Ruler className="h-2.5 w-2.5 flex-shrink-0" />
                <span>Длина: {config.dimensions.length} мм</span>
              </div>
              <div className="flex items-center gap-1">
                <Layers className="h-2.5 w-2.5 flex-shrink-0" />
                <span>Срезы: {config.edgeCuts.left === "Угловой срез 45°" ? "45°" : "90°"} / {config.edgeCuts.right === "Угловой срез 45°" ? "45°" : "90°"}</span>
              </div>
              <div className="flex items-center gap-1">
                <Circle className="h-2.5 w-2.5 flex-shrink-0" />
                <span>Рез: {(calculateTotalCutLength(config) / 1000).toFixed(3)} м</span>
              </div>
            </div>
          </div>
